...
plt.legend(handles=[f[0],f[1],f[2],f[3],f[4],f[5]], labels = ["Traj$(T^{(2)}_{1})$","Traj$(T^{(2)}_{2})$","Traj$(T^{(2)}_{3})$","Traj$(T^{(2)}_{4})$","Traj$(T^{(2)}_{5})$","Traj$(T^{(2)}_{6})$"], loc="lower right", ncol=3)

plt.title("Density")
plt.savefig("/home/chem/msrgxt/Desktop/a_2.png", dpi = 300)
plt.show()
