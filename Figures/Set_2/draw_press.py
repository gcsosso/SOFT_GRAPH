...
plt.legend(handles=[f[0],f[1],f[2],f[3],f[4],f[5],f[6],f[7],f[8],f[9]], labels = ["Traj$(T^{(2)}_{1})$","Traj$(T^{(2)}_{2})$","Traj$(T^{(2)}_{3})$","Traj$(T^{(2)}_{4})$","Traj$(T^{(2)}_{5})$","Traj$(T^{(2)}_{6})$","Traj$(T^{(2)}_{7})$","Traj$(T^{(2)}_{8})$","Traj$(T^{(2)}_{9})$","Traj$(T^{(2)}_{10})$"], loc="best", ncol=5)

plt.title("Pressure")
plt.savefig("/home/chem/msrgxt/Desktop/ans/c_2.png", dpi = 300)
plt.show()
